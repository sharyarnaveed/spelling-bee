...
<template>
  ...
  >
    ...
    <div class="absolute inset-0 overflow-hidden">
      ...
      ></div>
      <div
        class="absolute top-3/4 right-1/4 w-80 h-80 bg-pink-500/10 rounded-full blur-3xl animate-pulse"
        style="animation-delay: 2s"
      ></div>
      <div
        class="absolute bottom-1/4 left-1/3 w-64 h-64 bg-blue-500/10 rounded-full blur-3xl animate-pulse"
    ...
    >
      ...
      <div class="text-center mb-16">
        ...
        <div
          class="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 max-w-2xl mx-auto"
        >
    ...
    <div
      class="fixed top-20 left-20 text-6xl animate-bounce opacity-20"
      style="animation-delay: 0s"
    >
      🌟
    </div>
    <div
      class="fixed top-40 right-32 text-4xl animate-pulse opacity-20"
      style="animation-delay: 1s"
    >
      ✨
    </div>
    <div
      class="fixed bottom-32 left-40 text-5xl animate-bounce opacity-20"
      style="animation-delay: 2s"
    >
      🎯
    </div>
    <div
      class="fixed bottom-20 right-20 text-4xl animate-pulse opacity-20"
      style="animation-delay: 3s"
    >
      🏆
    </div>
    <div
      class="fixed top-1/2 left-10 text-3xl animate-bounce opacity-20"
      style="animation-delay: 4s"
    >
      🚀
    </div>
